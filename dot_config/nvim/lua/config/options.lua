...
vim.o.background = 'dark' -- Set termguicolors to enable highlight groups (default: false)
vim.o.whichwrap = 'bs<>[]hl' -- Which "horizontal" keys are allowed to travel to prev/next line (default: 'b,s')
vim.o.numberwidth = 3 -- Set number column width to 2 {default 4} (default: 4)
...
vim.o.updatetime = 200 -- Decrease update time (default: 4000)
