return {
  ...
  config = function ()
    ...
    vim.keymap.set('n', '<leader>ls', function() vim.lsp.buf.workspace_symbol() end, { desc = "Workspace symbol" })
    vim.keymap.set('n', '<leader>ld', function() vim.diagnostic.open_float() end, { desc = "Open diagnostic float" })
    vim.keymap.set('n', '<leader>lc', function() vim.lsp.buf.code_action() end, { desc = "Code action" })
